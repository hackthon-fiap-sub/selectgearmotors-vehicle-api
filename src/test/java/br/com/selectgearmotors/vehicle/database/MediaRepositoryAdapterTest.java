package br.com.selectgearmotors.vehicle.database;

import br.com.selectgearmotors.vehicle.application.api.exception.ResourceFoundException;
import br.com.selectgearmotors.vehicle.application.database.mapper.MediaMapper;
import br.com.selectgearmotors.vehicle.application.database.repository.MediaRepositoryAdapter;
...
import br.com.selectgearmotors.vehicle.infrastructure.repository.MediaRepository;
...
public class MediaRepositoryAdapterTest {
    ...
    public void testSave_Success() {
        ...
        when(mediaMapper.fromModelToEntity(media)).thenReturn(mediaEntity);
    ...
    public void testSave_ThrowsException() {
        Media media = new Media();
        when(mediaMapper.fromModelToEntity(media)).thenReturn(null);
